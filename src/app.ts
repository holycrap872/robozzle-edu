...
if (!self.__WB_pmw) { self.__WB_pmw = function (obj) { this.__WB_source = obj; return this; } }
{
    ...
    class Robozzle {
        ...
        setUserName(userName, password, solvedLevels, votes) {
            // Store the response
